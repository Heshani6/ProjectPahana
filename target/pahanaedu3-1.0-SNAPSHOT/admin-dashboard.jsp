...
<head>
  ...
  <style>
    ...
    .sidebar {
      width: 250px;
      background: #2d3142; /* Softer, elegant dark blue */
    ...
    .sidebar ul li a.active, .sidebar ul li a:hover {
      background: #a3cef1; /* Soft blue highlight */
      color: #2d3142;
    }
    .sidebar ul li a i {
      margin-right: 0.8rem;
  ...
  <!-- Optionally add FontAwesome or similar for icons -->
...
<body>
  <div class="sidebar">
    ...
    <ul>
      ...
      <li><a href="#"><i class="fas fa-box"></i>Item Management</a></li>
      <li><a href="#"><i class="fas fa-tags"></i>Category Management</a></li>
      <li><a href="#"><i class="fas fa-file-invoice-dollar"></i>Billing Control</a></li>
      <li><a href="#"><i class="fas fa-chart-bar"></i>Reporting</a></li>
  ...
  <div class="main-content">
    ...
    <div class="dashboard-cards">
      <div class="card">
        ...
        <div class="card-value"><%= request.getAttribute("staffCount") %></div>
      </div>
      <div class="card">
        <div class="card-title">Total Customers</div>
        <div class="card-value"><%= request.getAttribute("customerCount") %></div>
      </div>
      <div class="card">
        <div class="card-title">Total Items</div>
        <div class="card-value"><%= request.getAttribute("itemCount") %></div>
      </div>
      <div class="card">
        <div class="card-title">Pending Bills</div>
        <div class="card-value"><%= request.getAttribute("pendingBillCount") %></div>
      </div>
    </div>
    <!-- Add more widgets, charts, or recent activity here -->
  </div>
</body>
</html> 